      ...
      <main className="flex space-x-8">
        <section className="bg-white rounded-lg shadow p-6 flex-1">
          ...
          <div className="mb-6">
            ...
            <ul className="list-none p-0 grid grid-cols-2 gap-4">
              <li className="bg-blue-100 text-blue-700 rounded-lg px-3 py-1">Creative Design</li>
              <li className="bg-blue-100 text-blue-700 rounded-lg px-3 py-1">Problem Solving</li>
              <li className="bg-blue-100 text-blue-700 rounded-lg px-3 py-1">Web Development</li>
              <li className="bg-blue-100 text-blue-700 rounded-lg px-3 py-1">Project Management</li>
            </ul>
          </div>
        ...
        <aside className="bg-white rounded-lg shadow p-6 w-80">
          ...
          <ul className="list-none p-0 space-y-4">
            <li className="bg-blue-100 text-blue-700 rounded-lg px-3 py-2">
