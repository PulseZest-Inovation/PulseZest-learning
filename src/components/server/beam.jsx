...
export function AnimatedBeamDemo() {
  ...
  .jiggle-on-hover:hover {
    animation: jiggle 0.6s ease-in-out infinite, pulse 1s infinite;
  }
...
`}</style>
      ...
      >
        ...
        <div className="relative flex h-full w-1/2 items-center justify-center p-4">
          <div className="relative w-full max-w-xs bg-gray-800 text-white p-4 rounded-lg shadow-md jiggle-on-hover">
            ...
            <h2 className="text-lg font-bold">Data Flow In server</h2>
            <p className="mt-2 text-sm">
            Data flow in a server 🌐 is crucial for efficient operation. It involves the movement of data between various components, including storage 🗄️, processing units 💻, and network interfaces 🌐. This seamless flow ensures that requests are handled promptly and information is accessible as needed. Effective data flow management enhances performance 🚀 and reliability, keeping everything running smoothly.
            </p>
          </div>
        </div>
...
const Icons = {
  ...
  openai: () => (
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <path d="M3 2C2.44772 2 2 2.44772 2 3V21C2 21.5523 2.44772 22 3 22H21C21.5523 22 22 21.5523 22 21V3C22 2.44772 21.5523 2 21 2H3ZM3 0H21C22.6569 0 24 1.34315 24 3V21C24 22.6569 22.6569 24 21 24H3C1.34315 24 0 22.6569 0 21V3C0 1.34315 1.34315 0 3 0ZM6 4H18V6H6V4ZM6 8H18V10H6V8ZM6 12H18V14H6V12ZM6 16H18V18H6V16ZM6 20H18V22H6V20Z"/>
  </svg>
  ),
  googleDrive: () => (
    <svg
